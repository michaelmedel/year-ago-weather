module.exports = async (req, res) => {
  ...
  async function generateWittyCommentary(weatherData) {
    ...
    const prompt = `You are a witty, edgy weather commentator. Generate ONE short, clever comment (max 20 words) comparing today's weather to last year. Be sarcastic and funny but avoid politics, religion, and controversial topics.

Today in ${location}: ${todayTemp}° and ${todayWeather}
Last year: ${lastTemp}° and ${lastWeather}
